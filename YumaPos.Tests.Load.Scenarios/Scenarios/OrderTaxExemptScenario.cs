...
namespace YumaPos.Tests.Load.Scenarios
{
    internal class OrderTaxExemptScenario : IScenario
    {
        ...
        public OrderTaxExemptScenario(ITerminalApi terminalApi, IMenuAvailabilityHelper menuAvailabilityHelper)
        {
            _api = terminalApi;
        ...
        public async Task StartAsync()
        {
            ...
            var addTaxExemptResponse = await _api.UpdateTaxExempt(orderId,0,true);
