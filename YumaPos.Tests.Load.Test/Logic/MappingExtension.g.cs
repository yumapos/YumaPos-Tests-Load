...
namespace YumaPos.Tests.Load.Test.Logic 
{
    public static class MapExtensions 
    {
        
        public static YumaPos.Tests.Load.Infrastucture.Dto.ReportDto MapToDto (this YumaPos.Tests.Load.Data.Models.Report item)
        {  
            //itemDo.ReportId
        ...
        public static YumaPos.Tests.Load.Data.Models.Report MapFromDto (this YumaPos.Tests.Load.Infrastucture.Dto.ReportDto itemDto)
        {  
            if (itemDto == null) return null;
            
            var item = new YumaPos.Tests.Load.Data.Models.Report ();
                item.TaskId = itemDto.TaskId;
            
            return item;
        }
        
        public static YumaPos.Tests.Load.Infrastucture.Dto.TestTaskDto MapToDto (this YumaPos.Tests.Load.Data.Models.TestTask item)
        {  
            ...
            var itemDto = new YumaPos.Tests.Load.Infrastucture.Dto.TestTaskDto ();
                ...
                itemDto.ClientIsRegistered = item.ClientIsRegistered;

            return itemDto;
        }

        public static YumaPos.Tests.Load.Data.Models.TestTask MapFromDto (this YumaPos.Tests.Load.Infrastucture.Dto.TestTaskDto itemDto)
        {  
            if (itemDto == null) return null;
            
            var item = new YumaPos.Tests.Load.Data.Models.TestTask ();
                item.TaskId = itemDto.TaskId;
                ...
                item.ClientIsRegistered = itemDto.ClientIsRegistered;
